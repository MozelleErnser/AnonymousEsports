...
/**
 * @title AnonymousEsportsCompatible
 * @dev Compatible version using working FHE library like reference
 */
contract AnonymousEsportsCompatible is SepoliaConfig {
    ...
    /**
     * @dev Submit a confidential vote - compatible version
     ...
     * @param _comment Public comment (kept for compatibility)
     */
    function submitVote(
        ...
        // Encrypt using compatible FHE library
        ebool encryptedVote = FHE.asEbool(_vote);
        euint8 encryptedRating = FHE.asEuint8(_rating);

        // Set ACL permissions following reference pattern
    ...
    /**
     * @dev Get all competitions available for voting
     */
    ...
    /**
     * @dev Toggle competition active status
     */
